import VueDraggable from '../../lib/vue-draggable/index.js';
    ...
    return {
        ...
        data: function(){
            return {
                ...
                result: "",
                dragDropOptions: {
                    dropzoneSelector: '.drop-container',
                    draggableSelector: '.answer',
                    handlerSelector: null,
                    reactivityEnabled: true,
                    multipleDropzonesItemsDraggingEnabled: true,
                    showDropzoneAreas: true,
                    onDrop: function(event) { 
                        let side = (event.droptarget.classList.contains("left"))?"left":"right";
                        
                        for(let item of event.items){
                            let index = item.getAttribute("value") * 1;
        ...
        methods: {
            ...
            isSelectedAnswer(answer, index){
                return this.selected[index] !== undefined;
            },
